...
import eu.hanna.movies.databinding.FragmentUpcomingBinding
...
class UpcomingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupRecyclerView()
        viewModel.getUpcomingMovies("en-US")
        observeUpcomingMovieFromViewModel()
        onMovieItemClick()
    }
    ...
    private fun observeUpcomingMovieFromViewModel(){
            ...
            when(response) {
                is NetworkResource.Success -> {
                    ...
                    response.data?.let { moviesResponse ->
                        ...
                        if(isLastPage) {
                            binding.rvUpcoming.setPadding(0, 0, 0, 0)
                        }
                    }
                }
                is NetworkResource.Error -> {
                    ...
                    response.message?.let { message ->
                        Log.e("upComingMovies", "An error occured: $message")
                    }
